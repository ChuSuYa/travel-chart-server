...
/**
 * Universal travel plan generation request DTO shared across all modules.
 * Moved to common to resolve cross-module reference issue
 * (UserProfileService previously imported it from planservice.dto which is not accessible).
 */
@Data
